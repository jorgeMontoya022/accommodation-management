...
public class RequestHostDto {
    ...
    @Schema(description = "Correo electrónico del anfitrión", example = "juan@example.com", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotBlank(message = "El email es obligatorio")
    @Email(message = "Email inválido")
    @Size(max = 150, message = "El email no puede exceder 150 caracteres")
    private String email;

    @Schema(description = "Fecha de nacimiento del anfitrión", example = "1990-05-15")
